                ...
                data.map(item=>{
                    return(
                        <div className="card home-card" style={{
                            maxWidth:"500px",height:"max-content",margin:"70px auto"
                        }}>
                            <div style={{display:"flex",justifyContent:"space-between"}}>
                                <div style={{display:"flex"}}>
                                    ...
                                    <h5 style={{paddingBottom:"20px",paddingLeft:"5px",color:"black"}}><Link to = {item.postedby._id != state._id ? "/profile/"+item.postedby._id:"/profile"}>{item.postedby.username}</Link></h5>
                                </div>
                                {
                                    console.log("hi"),
